...
* 项目配置
** rules
#+begin_src makefile :mkdirp yes :tangle /dev/shm/card-reader/libopencm3.rules.mk
  ##
...
#+begin_src makefile :mkdirp yes :tangle /dev/shm/card-reader/libopencm3.target.mk
  ##
  ## This file is part of the libopencm3 project.
  ##
  ## Copyright (C) 2009 Uwe Hermann <uwe@hermann-uwe.de>
...
** ld
#+begin_src makefile :mkdirp yes :tangle /dev/shm/card-reader/stm32f0.ld
...
#+begin_src makefile :mkdirp yes :tangle /dev/shm/card-reader/Makefile
  BINARY = card-reader
  OBJS += common_payload.o card-reader-fsm.o card_payload.o proto-fsm.o epigyny.o hash.o led.o packet.o ring.o speaker.o utility.o wiegand.o wiegand-fsm.o zeropack.o

  include config

  CFLAGS += -DZEROPACK_CARD_PAYLOAD_ENABLED -DZEROPACK_COMMON_PAYLOAD_ENABLED -D CARD_READER_ID=$(CARD_READER_ID) -D SLOT_LEN=$(SLOT_LEN)
  ifdef ATTACKING_MODE
  CFLAGS += -DATTACKING_MODE
  endif
...
** config
#+begin_src makefile :mkdirp yes :tangle /dev/shm/card-reader/config.orig
  CARD_READER_ID=${ID}
  #SEGMENT=TM1637
  #SEGMENT=TM1650
  SEGMENT=${LED}
